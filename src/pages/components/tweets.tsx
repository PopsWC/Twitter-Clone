...
const Tweets = (tweetData: TweetData) => {
    ...
    return (
        <div className="block max-w-sm p-6 my-1 border-2 border-black min-w-full rounded-md bg-white hover:bg-slate-100">
            ...
            <div className="flex flex-row justify-end gap-3 pt-2">
                ...
                <button className="inline-flex items-center text-center text-white font-semibold" onClick={() => setShowModal(true)}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="black" className={shareData ? "w-6 h-6 stroke-sky-400" : "w-6 h-6 stroke-black"}>
                        <path stroke-linecap="round" stroke-linejoin="round" d="M7.5 8.25h9m-9 3H12m-9.75 1.51c0 1.6 1.123 2.994 2.707 3.227 1.129.166 2.27.293 3.423.379.35.026.67.21.865.501L12 21l2.755-4.133a1.14 1.14 0 01.865-.501 48.172 48.172 0 003.423-.379c1.584-.233 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0012 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018z" />
                    </svg>
                    <p className="font-semibold text-black pl-1">{0}</p>
                </button>
                {showModal ? (
                    <div className="fixed flex inset-0 h-full w-full bg-slate-100 items-center justify-center">
                        <div className="inline-flex flex-col w-1/2 h-2/3 border-2 p-2 border-black rounded-lg shadow-md bg-white ">
                            <div className="flex flex-row min-w-full p-4 items-center">
                                <span className="text-black text-lg font-semibold">Reply To Tweet</span>
