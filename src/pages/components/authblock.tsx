        ...
        return (
            ...
            <div className="flex flex-col w-full max-w-sm h-full border border-gray-700 rounded-lg shadow-md bg-gray-800">
                <div className="flex flex-row w-full items-center ml-3 mt-3">
                    ...
                    <div className="flex flex-col w-auto p-3">
                    <a href={"/profile/" + userId} className=" hover:underline underline-offset-8 decoration-8 text-white">
                ...
                <div className="flex flex-row w-full h-auto items-center justify-center">
                    <div className="flex flex-col">
                        <h1 className="text-white text-sm">Buddy/Guy Best CSGO Player</h1>
                    </div>
                </div>
